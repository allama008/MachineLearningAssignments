...
'''
# Kindly uncomment this part for running CLT.
# for i in ['accidents', 'baudio', 'bnetflix', 'jester', 'kdd', 'msnbc', 'nltcs', 'plants', 'pumsb_star', 'tretail']:
#     for j in ['ts', 'valid', 'test']:
#         dataset = Util.load_dataset(r'"C:\Users\allam\Documents\Assignment\6375\HW4\datasets\dataset"{}.{}.data'.format(i,j))
#         print(i+":"+j)
