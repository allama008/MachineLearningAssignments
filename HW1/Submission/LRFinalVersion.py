...
class LogisticRegression:
    #TRAIN_PATH = "C:\\Users\\allam\\Documents\\Assignment\\6375\\Dataset\\Train\\hw1_train\\train"#'train'
    #TEST_PATH = "C:\\Users\\allam\\Documents\\Assignment\\6375\\Dataset\\Test\\hw1_test\\test"#'test'
    learning_rate = 0.001
    WEIGHTS = {}

    def __init__(self, _lambda, iterations, use_stop_words, classificationOption, TRAIN_PATH, TEST_PATH):
    ...
    def train(self):
        ...
        self.initMapList(self.TRAIN_PATH + "\\spam", 'spam') #'/spam'
        self.initMapList(self.TRAIN_PATH + "\\ham", 'ham') #'/ham'

        # print('Map List Checking.')
        # print(self.map_list[1])
    ...
    def classify(self):
        ...
        spam_count, spam_list = self.initList(self.TEST_PATH + "\\spam")#'/spam')
        ham_count, ham_list = self.initList(self.TEST_PATH + "\\ham") #'/ham')
        ...
        self.initMapList(self.TEST_PATH + "\\spam", 'spam') #'/spam'
        self.initMapList(self.TEST_PATH + "\\ham", 'ham') #'/ham'
    ...
    def cal(self, instance, class_name):
        ...
        #print(float(weight))
        exp_weight = np.exp(float(weight)) #math.exp(float(weight))
            ...
            with open(folder + '/' + file_name, 'r', encoding='utf-8', errors='ignore') as f:
                ...
                for word in temp:
                    if word in self.words_space_set:
                        ...
                        if self.classificationOption == 1 and tempMap[word] > 1:
                            tempMap[word] = 1
