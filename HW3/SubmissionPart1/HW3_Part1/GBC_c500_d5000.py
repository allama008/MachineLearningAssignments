...
TRAIN_PATH = "C:\\Users\\allam\\Documents\\Assignment\\6375\\HW3\\hw3_part1_data\\all_data\\train_c500_d5000.csv"
VALIDATION_PATH = "C:\\Users\\allam\\Documents\\Assignment\\6375\\HW3\\hw3_part1_data\\all_data\\valid_c500_d5000.csv"
TEST_PATH = "C:\\Users\\allam\\Documents\\Assignment\\6375\\HW3\\hw3_part1_data\\all_data\\test_c500_d5000.csv"
...
#Program Pipeline
print('\n')
print('c1000d5000 program begin execution')
exec(open('GBC_c1000_d5000.py').read())
print('\n')
print('c1500d1000 program begin execution')
exec(open('GBC_c1500_d1000.py').read())
print('\n')
print('c1500d5000 program begin execution')
exec(open('GBC_c1500_d5000.py').read())
